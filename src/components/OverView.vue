    ...
    addEntityPoint(data) {
      ...
      for (let i = 0; i < data.length; i++) {
        ...
        const entity = new Cesium.Entity({
          id: item["旅游景区名称"],
          //   description: `<div style="height: 250px;"><img src='http://localhost:8080/v3dmap/img/div2.43658800.png'></div>`,
...
.divpoint1 {
  ...
  background: url("../assets/img/div1.png");
  background-size: 100%;
...
.mars3d-divlabel::before {
  ...
  bottom: -39px;
  left: -22px;
  background: url("../assets/img/popupLbl.png") 0px 0px no-repeat;
